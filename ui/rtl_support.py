...
TRANSLATIONS = {
    "he": {
        ...
        "sidebar_upload_override_warning": "העלאת קובץ כאן תחליף את הקובץ הנוכחי",
...
- **סינון שקפים**: השתמשו בתיבת החיפוש בסרגל הצדי לסינון לפי מספר שקף או שם גרף""",
    ...
    "en": {
        ...
        "sidebar_upload_override_warning": "Uploading a file here will replace the currently loaded file",
